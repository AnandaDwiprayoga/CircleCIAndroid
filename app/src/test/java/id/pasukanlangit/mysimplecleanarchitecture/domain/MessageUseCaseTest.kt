...
class MessageUseCaseTest {
    ...
    fun setUp(){
        ...
        val dummyMessage = MessageEntity("Hello $NAME, print from clean architecture")
        `when`(messageRepository.getWelcomeMessage(name = NAME)).thenReturn(dummyMessage)
    }
    ...
    fun `should get data from repository`(){
        ...
        assertEquals("Hello $NAME, print from clean architecture", message.welcomeMessage)
    }
